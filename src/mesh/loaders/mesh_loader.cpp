...
Mesh* MeshLoader::LoadDome() {
    vector<Vertex> vertices;
    vector<GLuint> indices;
    vector<Texture> textures;

    std::cout << "Loading Dome" << std::endl;
    ...
    TextureLoader textureLoader;
    Texture textureDiffuse = textureLoader.LoadSkydome();
    Texture textureSpecular = textureLoader.LoadSkydome();
    textures.push_back(textureDiffuse);
    textures.push_back(textureSpecular);
    ...
    std::cout << "Finished Loading Dome" << std::endl;
